...
class Trainer:
    def __init__(self, options):
        ...
        self.adaptive_image_loss_func = AdaptiveImageLossFunction(image_size, np.float32, 0, color_space='YUV', representation= 'CDF9/7', alpha_lo=0.001, alpha_hi=1.999, scale_lo=1.0, scale_init=1.0)
    ...
    def adaptive_loss(self, pred, target):
        ...
        return self.adaptive_image_loss_func.lossfun(target-pred)#self.adaptive_image_loss_func.lossfun(y).permute(0, 3, 2, 1)
    ...
    def compute_losses(self, inputs, outputs, is_multi=False):
        ...
        for scale in self.opt.scales:
            ...
            reprojection_losses_adaptive = reprojection_losses_adaptive.mean()
